package de.thaso.swa.app.it.glassfish;

import de.thaso.swa.db.schema.PropertiesManager;
import de.thaso.swa.app.it.base.ApplicationServerBase;
import de.thaso.swa.app.it.utils.CommandParamBuilder;
...
public class GlassfishEmbeddedServer implements ApplicationServerBase {
    ...
    private void deployApp() throws GlassFishException {
        final File ear = new File("./target/ear/swa-app-ear-1.0-SNAPSHOT.ear");
