...
@ConnectionDefinition(
        connectionFactory = FumConnectionFactory.class,
        connectionFactoryImpl = FumConnectionFactoryImpl.class,
        connection = FumConnection.class,
        connectionImpl = FumConnectionImpl.class
)
public class FumManagedConnectionFactory implements ManagedConnectionFactory,
        ResourceAdapterAssociation,
        Serializable,
        Referenceable {
    private static final long serialVersionUID = -6417177656213676170L;
