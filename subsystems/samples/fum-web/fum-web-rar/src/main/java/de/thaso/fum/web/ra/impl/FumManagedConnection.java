...
public class FumManagedConnection implements ManagedConnection {
    ...
    private FumConnection connection;
...
//        for (FumConnectionImpl con : createdConnections)
//            if (con != null)
//                con = null;
//                //con.invalidate();
    ...
    public void associateConnection(final Object connection) throws ResourceException {
        this.connection = (FumConnection) connection;
        ((FumConnectionImpl)connection).setManagedConnection(this);
        ((FumConnectionImpl)connection).setManagedConnectionFactory(managedConnectionFactory);
    }
