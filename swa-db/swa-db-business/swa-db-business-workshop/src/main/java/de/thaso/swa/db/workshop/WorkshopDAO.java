...
public class WorkshopDAO {
    ...
    public List<WorkshopEntity> findFromDate(final Date date) {
        LOG.info("findFromDate( {} )", date);

        final TypedQuery<WorkshopEntity> query
                = entityManager.createNamedQuery(WorkshopEntity.FIND_FROM_DATE, WorkshopEntity.class);
