package de.thaso.swa.db.workshop;
...
@NamedQueries({
        @NamedQuery(name = WorkshopEntity.FIND_ALL, query = "select w from WorkshopEntity w order by w.dayOfEvent asc"),
        ...
        @NamedQuery(name = WorkshopEntity.FIND_FROM_DATE, query = "select w from WorkshopEntity w where w.dayOfEvent >= :date order by w.dayOfEvent asc"),
})
public class WorkshopEntity extends EntityBase {
    ...
    public static final String FIND_FROM_DATE = "FIND_FROM_DATE";
